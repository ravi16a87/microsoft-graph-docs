...
### Example 3: Create an online meeting with user token and override default meeting properties

The following example creates an online meeting with a user token and override default meeting properties "allowMeetingChat" to disabled.
